...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "HR"."AFICIÓN"."AFICIÓN_ID" IS 'Clave Primaria';
   COMMENT ON COLUMN "HR"."AFICIÓN"."NOMBRE_GUERRA" IS 'Nombre de guerra de la afición';
   COMMENT ON COLUMN "HR"."AFICIÓN"."EQUIPO_ID" IS 'Clave Ajena';
   COMMENT ON COLUMN "HR"."AFICIÓN"."ABONADOS" IS 'Número de abonados';
--------------------------------------------------------
--  DDL for Table CÁNTICOS
--------------------------------------------------------

  CREATE TABLE "HR"."CÁNTICOS" 
   (	"CÁNTICO_ID" NUMBER, 
	"AFICIÓN_ID" NUMBER, 
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "HR"."CÁNTICOS"."CÁNTICO_ID" IS 'Clave Primaria';
   COMMENT ON COLUMN "HR"."CÁNTICOS"."AFICIÓN_ID" IS 'Clave Ajena';
   COMMENT ON COLUMN "HR"."CÁNTICOS"."TÍTULO_CANCIÓN" IS 'Título del cántico';
   COMMENT ON COLUMN "HR"."CÁNTICOS"."FECHA_COMPOSICIÓN" IS 'Fecha de la composición del cántico';
   COMMENT ON COLUMN "HR"."CÁNTICOS"."LETRA_CANCIÓN" IS 'Letra de la canción';
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "HR"."EQUIPO"."EQUIPO_ID" IS 'Clave Primaria';
   COMMENT ON COLUMN "HR"."EQUIPO"."NOMBRE" IS 'Denominación del equipo';
   COMMENT ON COLUMN "HR"."EQUIPO"."FECHA_FUNDACIÓN" IS 'Fecha de la fundación del equipo';
   COMMENT ON COLUMN "HR"."EQUIPO"."LOCALIDAD" IS 'Localidad a la que pertenece el equipo';
   COMMENT ON COLUMN "HR"."EQUIPO"."DIVISIÓN" IS 'División en la que juega el equipo';
   COMMENT ON COLUMN "HR"."EQUIPO"."ESTADIO_ID" IS 'Clave Ajena';
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "HR"."ESTADIOS"."ESTADIO_ID" IS 'Clave Primaria';
   COMMENT ON COLUMN "HR"."ESTADIOS"."NOMBRE" IS 'Nombre del estadio';
   COMMENT ON COLUMN "HR"."ESTADIOS"."EMPLAZAMIENTO" IS 'Lugar de emplazamiento del estadio';
   COMMENT ON COLUMN "HR"."ESTADIOS"."CAPACIDAD" IS 'Aforo del estadio';
   COMMENT ON COLUMN "HR"."ESTADIOS"."FECHA_CONSTRUCCIÓN" IS 'Fecha de construcción del estadio';
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "HR"."JUGADORES"."NOMBRE" IS 'Nombre del jugador';
   COMMENT ON COLUMN "HR"."JUGADORES"."APELLIDOS" IS 'Apellidos del jugador';
   COMMENT ON COLUMN "HR"."JUGADORES"."EDAD" IS 'Edad del jugador';
   COMMENT ON COLUMN "HR"."JUGADORES"."DORSAL" IS 'Número del dorsal del jugador';
   COMMENT ON COLUMN "HR"."JUGADORES"."DEMARCACIÓN" IS 'Posición de juego natural del  jugador';
--------------------------------------------------------
...
REM INSERTING into HR."AFICIÓN"
SET DEFINE OFF;
Insert into HR."AFICIÓN" ("AFICIÓN_ID",NOMBRE_GUERRA,EQUIPO_ID,ABONADOS) values ('1','BUKANEROS','1','9500');
REM INSERTING into HR."CÁNTICOS"
SET DEFINE OFF;
Insert into HR."CÁNTICOS" ("CÁNTICO_ID","AFICIÓN_ID","TÍTULO_CANCIÓN","FECHA_COMPOSICIÓN","LETRA_CANCIÓN") values ('1','1','LA VIDA PIRATA',null,'La vida pirata es la vida mejor:
sin estudiar,
sin trabajar...
...
Insert into HR."CÁNTICOS" ("CÁNTICO_ID","AFICIÓN_ID","TÍTULO_CANCIÓN","FECHA_COMPOSICIÓN","LETRA_CANCIÓN") values ('2','1','A LAS ARMAS!',null,'A las Armas,
A las Armas,
A las Armas,
A las Armas.
...
SET DEFINE OFF;
Insert into HR.EQUIPO (EQUIPO_ID,NOMBRE,"FECHA_FUNDACIÓN",LOCALIDAD,"DIVISIÓN",ESTADIO_ID) values ('1','A.D. RAYO VALLECANO',to_date('01/01/24','DD/MM/RR'),'VALLEKAS','2A','1');
REM INSERTING into HR.ESTADIOS
SET DEFINE OFF;
Insert into HR.ESTADIOS (ESTADIO_ID,NOMBRE,EMPLAZAMIENTO,CAPACIDAD,"FECHA_CONSTRUCCIÓN") values ('1','ESTADIO MUNICIPAL DE VALLECAS','VALLEKAS','14000',to_date('01/01/24','DD/MM/RR'));
...
SET DEFINE OFF;
Insert into HR.JUGADORES (JUGADORES_ID,EQUIPO_ID,NOMBRE,APELLIDOS,EDAD,DORSAL,"DEMARCACIÓN") values ('1','1','TOÑO','MARTÍNEZ','36','1','PORTERO');
Insert into HR.JUGADORES (JUGADORES_ID,EQUIPO_ID,NOMBRE,APELLIDOS,EDAD,DORSAL,"DEMARCACIÓN") values ('2','1','ROBERTO','TRASHORRAS','35','10','CENTRO');
Insert into HR.JUGADORES (JUGADORES_ID,EQUIPO_ID,NOMBRE,APELLIDOS,EDAD,DORSAL,"DEMARCACIÓN") values ('3','1','ÁLEX','MORENO','23','6','DELANTERO');
...
--------------------------------------------------------
--  DDL for Index CÁNTICOS_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "HR"."CÁNTICOS_PK" ON "HR"."CÁNTICOS" ("CÁNTICO_ID") 
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index AFICIÓN_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "HR"."AFICIÓN_PK" ON "HR"."AFICIÓN" ("AFICIÓN_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
--  Constraints for Table AFICIÓN
--------------------------------------------------------

  ALTER TABLE "HR"."AFICIÓN" MODIFY ("EQUIPO_ID" NOT NULL ENABLE);
  ALTER TABLE "HR"."AFICIÓN" ADD CONSTRAINT "AFICIÓN_PK" PRIMARY KEY ("AFICIÓN_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "HR"."AFICIÓN" MODIFY ("NOMBRE_GUERRA" NOT NULL ENABLE);
  ALTER TABLE "HR"."AFICIÓN" MODIFY ("AFICIÓN_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table CÁNTICOS
--------------------------------------------------------

  ALTER TABLE "HR"."CÁNTICOS" ADD CONSTRAINT "CÁNTICOS_PK" PRIMARY KEY ("CÁNTICO_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "HR"."CÁNTICOS" MODIFY ("TÍTULO_CANCIÓN" NOT NULL ENABLE);
  ALTER TABLE "HR"."CÁNTICOS" MODIFY ("AFICIÓN_ID" NOT NULL ENABLE);
  ALTER TABLE "HR"."CÁNTICOS" MODIFY ("CÁNTICO_ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "HR"."ESTADIOS" MODIFY ("NOMBRE" NOT NULL ENABLE);
...
--------------------------------------------------------
--  Ref Constraints for Table AFICIÓN
--------------------------------------------------------

  ALTER TABLE "HR"."AFICIÓN" ADD CONSTRAINT "EQUIPO_FK" FOREIGN KEY ("EQUIPO_ID")
	  REFERENCES "HR"."EQUIPO" ("EQUIPO_ID") ON DELETE SET NULL ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table CÁNTICOS
--------------------------------------------------------

  ALTER TABLE "HR"."CÁNTICOS" ADD CONSTRAINT "AFICIÓN_ID" FOREIGN KEY ("AFICIÓN_ID")
	  REFERENCES "HR"."AFICIÓN" ("AFICIÓN_ID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."EQUIPO" ADD CONSTRAINT "ESTADIO_ID" FOREIGN KEY ("ESTADIO_ID")
	  REFERENCES "HR"."ESTADIOS" ("ESTADIO_ID") ENABLE;
--------------------------------------------------------
